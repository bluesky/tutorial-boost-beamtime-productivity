...
informative when utilized in the designated environment. The notebook in part is a workbook and is designed to have some "missing" elements. Feel free to request other exercises or request more detailed hidden answers. 
